...
export const metadata = getSEOTags({
  title: "About Us - TendHunt | UK Procurement Intelligence",
  description:
    "We're building the future of UK procurement intelligence. Founded by public sector sales experts, TendHunt was born to help suppliers find and win government contracts more effectively.",
});
        ...
        <div className="grid grid-cols-1 gap-20 md:grid-cols-2">
          <div className="flex flex-col items-start justify-start">
            ...
            <SubHeading className="mt-6 mr-auto text-left">
              Founded by public sector sales experts and engineers, TendHunt
              was born out of a simple frustration: finding and winning UK
              government contracts still required too much manual research. We
              set out to change that by building an intelligence platform that
              surfaces opportunities before your competitors.
              <br /> <br />
              Today, TendHunt helps suppliers across the UK discover contracts,
              track buyer signals, and win more public sector business. Whether
              you're a startup targeting your first government deal or an
              established firm scaling your pipeline.
            </SubHeading>
          </div>
