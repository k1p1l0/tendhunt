...
export const metadata = getSEOTags({
  title: "Careers - TendHunt | UK Procurement Intelligence",
  description:
    "We're building the future of UK procurement intelligence. Join TendHunt and help suppliers find and win government contracts more effectively.",
});
