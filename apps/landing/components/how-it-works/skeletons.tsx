    ...
    <div className="mt-12 flex flex-col items-center">
      <div className="relative">
        <Card
          title="Email"
          subtitle="Sign Up"
          logo={<OrgLogo src="/logos/orgs/kent.png" alt="Kent" className="h-4 w-4 object-contain" />}
          cta="Verified"
          tone="default"
        />
      ...
      <div className="mt-12 flex flex-row gap-4.5">
        <Card
          title="Company"
          subtitle="Profile"
          logo={<OrgLogo src="/logos/orgs/nhs-england.png" alt="NHS" className="h-4 w-4 object-contain" />}
          cta="Uploaded"
          tone="danger"
          delay={0.2}
        />
        <Card
          title="LinkedIn"
          subtitle="Connect"
          logo={<OrgLogo src="/logos/orgs/manchester.png" alt="Manchester" className="h-4 w-4 object-contain" />}
          cta="Synced"
          tone="default"
          delay={0.4}
        />
        <Card
          title="Credits"
          subtitle="10 Free"
          logo={<OrgLogo src="/logos/orgs/city-of-london.png" alt="City of London" className="h-4 w-4 object-contain" />}
          cta="Activated"
          tone="success"
          delay={0.6}
        />
...
export const ConnectYourTooklsSkeleton = () => {
  const text = `Search NHS contracts above £1M in London with AI scoring enabled.`;
    ...
    <div className="relative flex h-full w-full items-center justify-between">
      ...
      >
        <div className="absolute -top-4 -right-4 flex h-14 w-14 items-center justify-center rounded-lg bg-white shadow-xl">
          <Scale />
          <OrgLogo src="/logos/orgs/west-midlands.png" alt="West Midlands" className="relative z-20 h-8 w-8 object-contain" />
        </div>
      ...
      >
        ...
        <div className="mt-4 flex items-center justify-between gap-2">
          <div className="flex items-center gap-2">
            <OrgLogo src="/logos/orgs/hampshire.png" alt="Hampshire" className="h-4 w-4 shrink-0 object-contain" />
            <span className="text-charcoal-700 text-xs font-medium md:text-sm dark:text-neutral-200">
              Find a Tender
            </span>
          </div>
        ...
        <div className="mt-4 flex items-center justify-between gap-2">
          <div className="flex items-center gap-2">
            <OrgLogo src="/logos/orgs/sheffield.png" alt="Sheffield" className="h-4 w-4 shrink-0 object-contain" />
            <span className="text-charcoal-700 text-xs font-medium md:text-sm dark:text-neutral-200">
              Contracts Finder
            </span>
          </div>
...
export const DeployAndScaleSkeleton = () => {
  ...
  // Define reveal cards data for reusability
  const deployCards = [
    { title: "reveal-nhs-digital-001", subtitle: "1 credit", branch: "IT Services" },
    {
      title: "reveal-mod-cyber-002",
      subtitle: "1 credit",
      branch: "Cyber Security",
      variant: "success" as const,
    },
    { title: "reveal-hmrc-cloud-003", subtitle: "1 credit", branch: "Cloud" },
    {
      title: "reveal-defra-analytics-004",
      subtitle: "1 credit",
      branch: "Analytics",
      variant: "success" as const,
    },
    {
      title: "reveal-home-office-data-005",
      subtitle: "1 credit",
      branch: "Data",
      variant: "warning" as const,
    },
    {
      title: "reveal-transport-digital-006",
      subtitle: "1 credit",
      branch: "Digital",
      variant: "success" as const,
    },
    {
      title: "reveal-justice-consulting-007",
      subtitle: "1 credit",
      branch: "Consulting",
      variant: "danger" as const,
    },
    {
      title: "reveal-education-healthcare-008",
      subtitle: "1 credit",
      branch: "Healthcare",
      variant: "default" as const,
    },
    {
      title: "reveal-cabinet-office-it-009",
      subtitle: "1 credit",
      branch: "IT Services",
      variant: "success" as const,
    },
    {
      title: "reveal-treasury-cyber-010",
      subtitle: "1 credit",
      branch: "Cyber Security",
      variant: "warning" as const,
    },
    {
      title: "reveal-foreign-office-cloud-011",
      subtitle: "1 credit",
      branch: "Cloud",
      variant: "success" as const,
    },
    {
      title: "reveal-energy-analytics-012",
      subtitle: "1 credit",
      branch: "Analytics",
      variant: "default" as const,
    },
