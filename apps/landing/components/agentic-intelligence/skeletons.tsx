...
import { GoogleSheetsIcon } from "@/icons/uk-gov";
  ...
  const models = [
    {
      ...
      status: "142 contracts",
      variant: "danger",
    },
    {
      name: "City of London",
      logo: "/logos/orgs/city-of-london.png",
      status: "89 contracts",
      variant: "success",
    },
    {
      name: "West Midlands",
      logo: "/logos/orgs/west-midlands.png",
      status: "56 contracts",
      variant: "warning",
    },
  ];
      ...
      >
        <div className="flex w-full items-center justify-between p-2">
          <div className="flex items-center gap-2 font-medium">
            <OrgLogo src="/logos/orgs/kent.png" alt="Kent" className="h-4 w-4 object-contain" />
            Find a Tender
          </div>
          <p className="font-mono text-gray-600">API</p>
        </div>
        <DivideX />
        ...
        <div className="relative" key={model.name + index}>
          ...
          >
            <div className="flex items-center gap-2">
              <OrgLogo src={model.logo} alt={model.name} className="h-4 w-4 shrink-0 object-contain" />
              <span className="text-charcoal-700 text-sm font-medium dark:text-neutral-200">
                {model.name}
              </span>
            </div>
...
export const TextToWorkflowBuilderSkeleton = () => {
  const initialChat = [
    {
      role: "user",
      content: "What contracts match my IT security capabilities?",
    },
    {
      role: "assistant",
      content: "I found 47 contracts scoring 8+ for your profile. Top match: MOD Cyber Security Framework, score 9.2/10.",
    },
    {
      role: "user",
      content:
        "Show me NHS contracts above £500K in London",
    },
    {
      role: "assistant",
      content: "Found 12 NHS contracts in London above £500K. Highest scored: NHS Digital Cloud Migration at 8.7/10.",
    },
  ];
  ...
  const RANDOM_MESSAGES = [
    "I've scored 200+ contracts for your profile. Check the dashboard for results.",
    "Your top sectors are IT Services and Cyber Security based on past bids.",
    "3 new contracts published today match your profile above threshold 7.",
    "Analyzing buyer patterns for Ministry of Defence contracts...",
    "Top opportunity: NHS Digital Framework, 9.1/10 match score.",
    "Found 8 contracts closing this week that match your capabilities.",
  ];
      ...
      <motion.div className="relative mx-auto my-12 hidden h-full max-h-70 min-h-80 max-w-[67rem] grid-cols-2 p-4 lg:grid">
        <div className="flex items-center justify-between">
          <div className="flex flex-col gap-10">
            <TextIconBlock icon={<WindowIcon />} text="Contract Search">
              <TopSVG className="absolute top-2 -right-84" />
            </TextIconBlock>
            <TextIconBlock icon={<CodeIcon />} text="Buyer Profiles">
              <MiddleSVG className="absolute top-2 -right-84" />
            </TextIconBlock>
            <TextIconBlock icon={<PhoneIcon />} text="Contact Reveal">
        ...
        <div className="relative flex h-full w-full items-center justify-start">
          ...
          <div className="relative flex flex-col items-center gap-2">
            ...
            <div className="absolute inset-x-0 -top-30 flex h-full flex-col items-center">
              <IconBlock icon={<OrgLogo src="/logos/orgs/nhs-england.png" alt="NHS England" className="size-6 object-contain" />} />
              <VerticalLine />
              <VerticalLine />
              <IconBlock icon={<OrgLogo src="/logos/orgs/manchester.png" alt="Manchester" className="size-6 object-contain" />} />
            </div>
          </div>
          <div className="2 absolute -top-4 right-30 flex h-full flex-col items-center">
            <IconBlock icon={<GoogleSheetsIcon className="size-6" />} />
            <VerticalLine />
