...
export const CTA = () => {
  return (
    <Container className="border-divide relative flex min-h-60 flex-col items-center justify-center overflow-hidden border-x px-4 py-4 md:min-h-120">
      ...
      <AnimateInView className="relative z-10">
        <SectionHeading className="text-center lg:text-6xl">
          Ready to find your <br /> next contract?
        </SectionHeading>
      </AnimateInView>
      <AnimateInView delay={0.08} className="relative z-10">
        <p className="mx-auto mt-4 max-w-md text-center text-sm text-gray-600 dark:text-gray-400">
          Join hundreds of suppliers already on the waitlist for early access to TendHunt.
        </p>
      </AnimateInView>
      <AnimateInView delay={0.16} y={10} className="relative z-20">
        <Button as={Link} href="#waitlist" className="mt-4">
          Get Early Access
        </Button>
      </AnimateInView>
    </Container>
...
export const CTAOrbit: React.FC<CTAOrbitProps> = ({
  ...
  const logos: LogoItem[] = [
    { src: "/logos/orgs/nhs-england.png", alt: "NHS England" },
    { src: "/logos/orgs/manchester.png", alt: "Manchester" },
    { src: "/logos/orgs/city-of-london.png", alt: "City of London" },
    { src: "/logos/orgs/leeds.png", alt: "Leeds" },
    { src: "/logos/orgs/liverpool.png", alt: "Liverpool" },
    { src: "/logos/orgs/bristol.png", alt: "Bristol" },
    { src: "/logos/orgs/west-midlands.png", alt: "West Midlands" },
    { src: "/logos/orgs/sheffield.png", alt: "Sheffield" },
    { src: "/logos/orgs/kent.png", alt: "Kent" },
    { src: "/logos/orgs/hampshire.png", alt: "Hampshire" },
    { src: "/logos/orgs/nottingham.png", alt: "Nottingham" },
    { src: "/logos/orgs/cornwall.png", alt: "Cornwall" },
    { src: "/logos/orgs/network-rail.png", alt: "Network Rail" },
  ];
            ...
            return (
              ...
              >
                <div style={{ transform: `rotate(${-angleDeg}deg)` }}>
                  ...
                  >
                    <Image src={logo.src} alt={logo.alt} width={32} height={32} className="size-8 shrink-0 object-contain" />
                  </div>
                </div>
              </div>
            );
