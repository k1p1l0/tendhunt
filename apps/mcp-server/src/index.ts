  ...
  async (params) => {
    try {
      const result = await apiRequest(
        `/api/public/v1/buyers/${params.buyer_id}`
      );
      return formatResult(result);
    } catch (error) {
      return errorResult(error);
...
Args:
  ...
  async (params) => {
    try {
      const result = await apiRequest(
        `/api/public/v1/contracts/${params.contract_id}`
      );
      return formatResult(result);
    } catch (error) {
      return errorResult(error);
...
Args:
  ...
  async (params) => {
    try {
      const result = await apiRequest(
        `/api/public/v1/spend/${params.buyer_id}`
      );
      return formatResult(result);
    } catch (error) {
      return errorResult(error);
...
server.registerTool(
  "tendhunt_search_board_documents",
  {
...
Args:
  ...
  async (params) => {
    try {
      const result = await apiRequest(
        `/api/public/v1/scanners/${params.scanner_id}/columns`,
        "POST",
        { name: params.name, prompt: params.prompt }
      );
      return formatResult(result);
    } catch (error) {
      return errorResult(error);
